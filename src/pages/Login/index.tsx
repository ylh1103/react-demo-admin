function Login() {
  return (
    <div className="min-h-full bg-[rgb(9,10,12)] text-white">
      <header className="absolute left-0 right-0 top-0 z-40 h-16 bg-transparent">
        <div className="m-auto h-full max-w-screen-xl flex-y-center px-8">
          <img alt="Huly logo" width="71" height="24" decoding="async" data-nimg="1" src="https://huly.io/_next/static/media/d97ea0940c0302a26ddd7c1b56cf3346.svg" />
        </div>
      </header>
      <main>
        <section className="relative h-[1438px] overflow-hidden pt-[184px] <md:h-auto <xl:h-[1078px] <lg:pt-24 <md:pt-[92px] <xl:pt-28">
          <div className="relative m-auto h-full max-w-screen-xl flex-col px-8">
            <h1 className="relative z-30 max-w-[616px] text-[84px] text-transparent font-semibold tracking-tighter from-white via-[#d5d8f6] to-[#fdf7fe] from-30% via-80% bg-gradient-to-br bg-clip-text <lg:max-w-[441px] <md:max-w-64 <xl:max-w-[528px] <lg:text-[56px] <md:text-[32px] <xl:text-[72px]">
              记录.对比.协作
            </h1>
